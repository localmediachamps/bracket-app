...
export const api = {
  ...
  platformLeaderboardYears: () => get(XANO_APP, `/platform/leaderboard/years`),
  ...
  rankings: (params = {}) => get(XANO_APP, `/rankings${qs(params)}`),
  ...
  adminRankingsPool: (params = {}) => get(XANO_ADMIN, `/admin/rankings/pool${qs(params)}`),
